      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className={`relative my-4 w-full max-w-[95%] sm:max-w-3xl lg:max-w-7xl min-h-[50vh] max-h-[90vh] rounded-3xl bg-gradient-to-br from-white to-gray-50 overflow-y-auto transition-all duration-300 ${isRTL ? 'text-right' : 'text-left'}`}
