          ...
          {Object.entries(speakersData).map(([key, value]) => (
            ...
            >
              ...
              <div className="card-social">
                ...
                >
                  <p className={`${isArabic?"view-details-button__text-ar":"view-details-button__text-en"} text-gradient-to-r from-gray-900 to-gray-800 `}>
                    {value.button_text}
                  </p>  
                  <svg
              ...
              {selectedSpeaker?.name === value.name && (
                ...
                >
                  ...
                  >
                    <button
                      className={`absolute top-2 p-2 text-slate-600 hover:text-slate-800 focus:outline-none cursor-pointer ${isArabic?"left-2":"right-2"}`}
                      onClick={closeModal}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a
                      ...
                      className={`absolute top-12 p-2 text-slate-600 hover:text-slate-800 focus:outline-none cursor-pointer ${isArabic?" left-2":"right-2"}`}
                    >
